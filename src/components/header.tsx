        ...
        <div className='w-full max-w-4xl flex items-center justify-between gap-4'>
          <div className={clsx(
            ...
            <Link className='group active:opacity-100' href='/' tabIndex={-1}>
              <svg className='h-full w-full select-none group-hover:scale-110 rounded-full focus-visible' tabIndex={0} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" id="Layer_1" data-name="Layer 1" viewBox="0 0 1080 1080">
                <defs>
